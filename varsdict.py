...
#vardict['JpsiMu_mu3_pt'] = {'xtitle': 'p_{T} of the #mu_{3} (GeV)', 'nbins': 60, 'xmin': 10, 'xmax': 40, 'ytitle': '', 'isLog': False, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': -3} 
...
vardict['genBc_pt'] = {'xtitle': 'B_{c} pT', 'nbins': 100, 'xmin': 0, 'xmax': 100, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 4} 
