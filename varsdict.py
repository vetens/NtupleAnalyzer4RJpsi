...
vardict['mcorr'] = {'xtitle': 'm_{corr} [Gev]', 'nbins': 60, 'xmin': 0, 'xmax': 2, 'ytitle': '', 'isLog': False, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': -3} 
...
vardict['JpsiMu_B_pvip'] = {'xtitle': 'B_{c} Impact Parameter to the Primary Vertex', 'nbins': 60, 'xmin': 0, 'xmax': 0.5, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 4} 
...
vardict['cosdphi_mu1_mu3'] = {'xtitle': 'Cos(#Delta#phi_{#mu_{1},#mu_{3}})', 'nbins': 60, 'xmin': -1, 'xmax': 1, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 4} 
vardict['cosdphi_mu2_mu3'] = {'xtitle': 'Cos(#Delta#phi_{#mu_{2},#mu_{3}})', 'nbins': 60, 'xmin': -1, 'xmax': 1, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 4} 
...
vardict['cosdphi_Jpsi_mu3'] = {'xtitle': 'Cos(#Delta#phi_{J/#psi,#mu_{3}})', 'nbins': 60, 'xmin': -1, 'xmax': 1, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 4} 
...
vardict['JpsiMu_B_reliso'] = {'xtitle': 'Relative iso of the B_{c}', 'nbins': 60, 'xmin': 0, 'xmax': 1, 'ytitle': '', 'isLog': False, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': -3} 
...
vardict['JpsiMu_mu2_reldbiso'] = {'xtitle': 'Relative PF iso of the #mu_{2}', 'nbins': 60, 'xmin': 0, 'xmax': 10, 'ytitle': '', 'isLog': False, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': -3} 
vardict['JpsiMu_mu1_reldbiso'] = {'xtitle': 'Relative PF iso of the #mu_{1}', 'nbins': 60, 'xmin': 0, 'xmax': 10, 'ytitle': '', 'isLog': False, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': -3} 
...
vardict['JpsiMu_Jpsi_alpha'] = {'xtitle': 'J/#psi #alpha', 'nbins': 60, 'xmin': -1.5, 'xmax': 1.5, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 3.7} 
vardict['JpsiMu_B_alpha'] = {'xtitle': 'B_{c} #alpha', 'nbins': 60, 'xmin': -1.5, 'xmax': 1.5, 'ytitle': '', 'isLog': True, 'isRatio': False, 'isLegended': True, 'HasStackPlot': False, 'loglowerlimit': 2.9} 
...
#to_optimize['JpsiMu_B_fls3d'] = {'var': vardict['JpsiMu_B_fls3d'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.13, 'xmax': 80, 'xmin': 0}
#to_optimize['JpsiMu_B_fl3d'] = {'var': vardict['JpsiMu_B_fl3d'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.17, 'xmax': 1, 'xmin': 0}
#to_optimize['JpsiMu_Jpsi_fls3d'] = {'var': vardict['JpsiMu_Jpsi_fls3d'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.13, 'xmax': 30, 'xmin': 0}
#to_optimize['JpsiMu_Jpsi_fl3d'] = {'var': vardict['JpsiMu_Jpsi_fl3d'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 1, 'xmin': 0}
#to_optimize['JpsiMu_mu1_reliso'] = {'var': vardict['JpsiMu_mu1_reliso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 1, 'xmin': 0.01}
#to_optimize['JpsiMu_mu2_reliso'] = {'var': vardict['JpsiMu_mu2_reliso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 1, 'xmin': 0.01}
#to_optimize['JpsiMu_mu3_reliso'] = {'var': vardict['JpsiMu_mu3_reliso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 1, 'xmin': 0.01}
#to_optimize['JpsiMu_mu1_reldbiso'] = {'var': vardict['JpsiMu_mu1_reldbiso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 1, 'xmin': 0.01}
#to_optimize['JpsiMu_mu2_reldbiso'] = {'var': vardict['JpsiMu_mu2_reldbiso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 1, 'xmin': 0.01}
#to_optimize['JpsiMu_mu3_reldbiso'] = {'var': vardict['JpsiMu_mu3_reldbiso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 2, 'xmin': 0.01}
#to_optimize['JpsiMu_B_reliso'] = {'var': vardict['JpsiMu_B_reliso'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.1, 'xmax': 0.5, 'xmin': 0.01}
#to_optimize['JpsiMu_B_alpha'] = {'var': vardict['JpsiMu_B_alpha'], 'isgl': '>', 'granularity': 100.0, 'histscale': 0.05, 'xmax': 1, 'xmin': 0.98}
#to_optimize['JpsiMu_B_pvips'] = {'var': vardict['JpsiMu_B_pvips'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.2, 'xmax': 7, 'xmin': 0}
#to_optimize['JpsiMu_B_pvip'] = {'var': vardict['JpsiMu_B_pvip'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.12, 'xmax': 0.02, 'xmin': 0}
#to_optimize['JpsiMu_B_lips'] = {'var': vardict['JpsiMu_B_lips'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.13, 'xmax': 7, 'xmin': 0}
#to_optimize['JpsiMu_B_lip'] = {'var': vardict['JpsiMu_B_lip'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.12, 'xmax': 0.02, 'xmin': 0}
#to_optimize['JpsiMu_B_maxdoca'] = {'var': vardict['JpsiMu_B_maxdoca'], 'isgl': '<', 'granularity': 100.0, 'histscale': 0.07, 'xmax': 0.15, 'xmin': 0}
...
to_optimize['JpsiMu_B_mass'] = {'var': vardict['JpsiMu_B_mass'], 'isgl': '<', 'granularity': 36.0, 'histscale': 0.12, 'xmax': 9, 'xmin': 0}
#to_optimize['mcorr'] = {'var': vardict['mcorr'], 'isgl': '<', 'granularity': 36.0, 'histscale': 0.12, 'xmax': 9, 'xmin': 0}
...
corrpairs = [
    ...
    ['mcorr', 'JpsiMu_B_mass'],
    ['JpsiMu_B_pvip', 'JpsiMu_B_maxdoca'],
    ['JpsiMu_B_pvip', 'JpsiMu_B_mindoca'],
    ['JpsiMu_B_pvip', 'JpsiMu_B_fls3d'],
    ['JpsiMu_B_lips', 'JpsiMu_B_pvip'],
    ['JpsiMu_B_lips', 'JpsiMu_B_maxdoca'],
    ['JpsiMu_B_lips', 'JpsiMu_B_mindoca'],
    ['JpsiMu_B_fl3d', 'JpsiMu_B_mindoca'],
    ['JpsiMu_B_fl3d', 'JpsiMu_B_maxdoca'],
    ['JpsiMu_B_lips', 'JpsiMu_B_fls3d'],
    ['JpsiMu_B_pvip', 'JpsiMu_Jpsi_fls3d'],
    ['JpsiMu_Jpsi_fl3d', 'JpsiMu_B_mindoca'],
    ['JpsiMu_Jpsi_fl3d', 'JpsiMu_B_maxdoca'],
    ['JpsiMu_B_pt', 'JpsiMu_B_reliso'],
    ['JpsiMu_mu1_pt', 'JpsiMu_mu1_reldbiso'],
    ['JpsiMu_mu2_pt', 'JpsiMu_mu2_reldbiso'],
    ['JpsiMu_mu3_pt', 'JpsiMu_mu3_reldbiso'],
    ['JpsiMu_mu1_pt', 'JpsiMu_mu1_reliso'],
    ['JpsiMu_mu2_pt', 'JpsiMu_mu2_reliso'],
    ['JpsiMu_mu3_pt', 'JpsiMu_mu3_reliso']
