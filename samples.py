...
colours = {"dataA":1, "dataB":1, "dataC":1, "dataD":1, "bg_OniaAndX_MuMu_J_old":2, "signal_BcJpsiMuNu_old":3, "bg_BcJpsiTauNu":4, "bg_BcPsi2STauNu":5, "bg_OniaAndX_MuMu_J":7, "bg_BcPsi2SMuNu":8, "signal_BcJpsiMuNu":9}
styles ={"dataA":1, "dataB":1, "dataC":1, "dataD":1, "bg_OniaAndX_MuMu_J_old":2, "signal_BcJpsiMuNu_old":4, "bg_BcJpsiTauNu":3, "bg_BcPsi2STauNu":5, "bg_OniaAndX_MuMu_J":8, "bg_BcPsi2SMuNu":10, "signal_BcJpsiMuNu":1}
widths = {"dataA":3, "dataB":3, "dataC":3, "dataD":3, "bg_OniaAndX_MuMu_J_old":3, "signal_BcJpsiMuNu_old":3, "bg_BcJpsiTauNu":3, "bg_BcPsi2STauNu":3, "bg_OniaAndX_MuMu_J":3, "bg_BcPsi2SMuNu":3, "signal_BcJpsiMuNu":3}
...
sampledict['bg_OniaAndX_MuMu_J'] = {'file':bg_OniaAndX_MuMu_J,  'title':'Onia and X BG', 'digits':1, 'crossxn': 1.384*10**9, 'crossxnerr': 1.957*10**8}
